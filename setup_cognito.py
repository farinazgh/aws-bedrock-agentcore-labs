...
pool_response = cognito.create_user_pool(
    PoolName=user_pool_name, Policies={"PasswordPolicy": {"MinimumLength": 8}}
)
...
#  Create user with a temporary password (suppress email)
...
cognito.admin_set_user_password(
    UserPoolId=pool_id, Username=username, Password=permanent_password, Permanent=True
)
